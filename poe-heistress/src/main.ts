...
const createWindow = (): void => {
  ...
  */
  ...
  if (get_setting("enable_remote", false) as boolean) {
    const command_server = new WebSocketServer({port: 10635})
...
if (get_setting("enable_remote", false) as boolean) {
  const tracker_server = new WebSocketServer({port: 10636})
  ...
  const curio_server = new WebSocketServer({port: 10637})
  ...
  const pricer_server = new WebSocketServer({port: 10638})
